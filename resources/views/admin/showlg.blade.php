                                    ...
                                    @if (count($lg) > 0)
                                        @foreach ($lg as $lg)
                                            <tr>
                                                ...
                                                <td>
                                                  <a class="btn btn-info btn-sm" href="{{ route('admin.mkazi', $lg->id) }}">
                                                    <i class="fa fa-eye">
                                                    </i>
                                                    View Residents
                                                </a>
                                                ...
                                                <td>
                                                  <a class="btn btn-info btn-sm" href="{{ route('admin.nyumba', $lg->id) }}">
                                                    <i class="fa fa-eye">
                                                    </i>
                                                    View Houses
                                                </a>
                                                ...
                                                {{-- <td>
                                                  <a class="btn btn-info btn-sm" href="{{ route('admin.balozi', $lg->id) }}">
                                                    <i class="fa fa-eye">
                                                    </i>
                                                    View Balozi
                                                </a>
