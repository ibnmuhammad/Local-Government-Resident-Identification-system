...
@section('content')
    <div class="row justify-content-center">
      <div class="col-md-8">
          <div class="card">
              <div class="card-header">{{ __('Badilisha Taarifa zako') }}</div>
              ...
              <div class="card-body">
                  ...
                  <section class="content">
                    ...
                    <div class="container-fluid">
                      <form method="POST" action="{{ action('User\DashboardController@updateprofile') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="leader" type="text" class="form-control @error('leader') is-invalid @enderror" name="leader" value="{{ old('leader') }}" required autocomplete="leader">
