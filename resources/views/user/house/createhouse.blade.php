...
@section('content')
  <div class="row justify-content-center">
      <div class="col-md-8">
          <div class="card">
              <div class="card-header">{{ __('Sajili Nyumba Mpya') }}</div>
                    ...
                    <div class="container-fluid">
                        <form method="POST" action="{{ route('house.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="HouseNumber" type="text" class="form-control" name="HouseNumber" pattern="[A-Z]{3}/[0-9]{3}" placeholder="ABC/0001" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="owner" type="text" class="form-control @error('owner') is-invalid @enderror" name="owner" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                  <input id="phonenumber" type="tel" pattern="[0-9]{4}-[0-9]{6}" class="form-control @error('phonenumber') is-invalid @enderror" name="phonenumber" placeholder="eg: 0755-650650" required>
                            ...
                            {{-- <div class="form-group row">
                                <label for="balozi" class="col-md-4 col-form-label text-md-right">{{ __('Balozi') }}</label>
