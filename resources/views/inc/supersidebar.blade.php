<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/superadministrator" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/superadministrator" class="d-block">{{ Auth::user()->username }}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/superadministrator" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                {{-- <a href="{{ route('superadmin.show') }}" class="nav-link"> --}}
                <a href="{{ route('superadmin.index') }}" class="nav-link">
                  <i class="fas fa-users nav-icon"></i>
                  <p>District Administrators</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
            <a href="{{ route('superadmin.showlg') }}" class="nav-link">
